...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Netsky Code from reading sensitive files",
  "Use {highlight}netsky run{/highlight} for non-interactive scripting",
  "Use {highlight}netsky --continue{/highlight} to resume the last session",
  "Use {highlight}netsky run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}netsky serve{/highlight} for headless API access to Netsky Code",
  "Use {highlight}netsky run --attach{/highlight} to connect to a running server",
  "Run {highlight}netsky upgrade{/highlight} to update to the latest version",
  "Run {highlight}netsky auth list{/highlight} to see all configured providers",
  "Run {highlight}netsky agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}netsky github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}netsky debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}netsky web{/highlight} to open the browser interface",
