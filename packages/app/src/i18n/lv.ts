export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Netsky Code izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Netsky Code",
  "desktop.recovery.terminated": "Netsky Code logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Netsky Code neatbild",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code instalēšana neizdevās",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Netsky Code atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Netsky Code.",
  ...
  "dialog.server.description": "Mainiet, pie kura Netsky Code servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu Netsky Code distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu Netsky Code distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet Netsky Code distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet Netsky Code distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Netsky Code var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Netsky Code no jauna.",
  ...
  "help.tabs.introduction": "Netsky Code tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Netsky Code versija ({{version}}) instalēšanai.",
  ...
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Netsky Code vēl neatbalsta MCP autentifikāciju.',
  ...
  "app.name.desktop": "Netsky Code darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Netsky Code serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Netsky Code saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Netsky Code izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Netsky Code sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Netsky Code tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Netsky Code versiju.",
