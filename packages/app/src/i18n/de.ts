...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Netsky Code zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Netsky Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Netsky Code zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Netsky Code-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Code wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Netsky Code in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Netsky Code wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Netsky Code in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Netsky Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Netsky Code aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Netsky Code ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Netsky Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Netsky Code installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Netsky Code einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Netsky Code erneut.",
  ...
  "toast.update.description": "Eine neue Version von Netsky Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Netsky Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Netsky Code mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "settings.desktop.wsl.description": "Netsky Code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Netsky Code ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Netsky Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Netsky Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Netsky Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Netsky Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Netsky Code ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Netsky Code wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Netsky Code konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Netsky Code-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Netsky Code reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Netsky Code-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Netsky Code basiert jetzt auf Tabs.",
  "help.tabs.sessions":
