...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za Netsky Code",
  "Forum za podršku",
  "Pošalji povratne informacije",
  "Prijavi pogrešku",
  "Izbornik Netsky Code",
  ...
  "Nastavi čekati",
  "Izađi",
  "Netsky Code se nije uspio učitati",
  "Prozor aplikacije Netsky Code neočekivano je zatvoren",
  "Netsky Code ne reagira",
  ...
  "Instalacija aplikacije Netsky Code nije uspjela",
  ...
  "Netsky Code nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Netsky Code je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Netsky Code.",
  ...
  "dialog.server.description": "Promijenite na koji se Netsky Code poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Netsky Code u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Netsky Code u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Netsky Code u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Netsky Code u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Netsky Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Netsky Code može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Netsky Code.",
  ...
  "help.tabs.introduction": "Radna površina Netsky Code sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Netsky Code ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Netsky Code timu",
  "error.page.report.github": "na GitHub",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Netsky Code još ne podržava MCP autentifikaciju.',
  ...
  "app.name.desktop": "Netsky Code Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Netsky Code poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Netsky Code",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Netsky Code izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Netsky Code slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Netsky Code tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Netsky Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Netsky Code.",
