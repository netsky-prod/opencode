export const dict = {
  ...
  "desktop.recovery.loadFailed": "Netsky Codeを読み込めませんでした",
  "desktop.recovery.terminated": "Netsky Codeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Netsky Codeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Codeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはNetsky Codeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Netsky Codeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Netsky Codeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNetsky Codeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Netsky Codeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するNetsky Codeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Codeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のNetsky Codeを確認中...",
  "wsl.onboarding.updatingOpencode": "Netsky Codeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のNetsky Codeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のNetsky Codeを更新してください。",
  "wsl.onboarding.updateOpencode": "Netsky Codeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のNetsky Codeの準備ができました。",
  "wsl.onboarding.opencodeReady": "Netsky Codeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にNetsky Codeをインストールしてください。",
  "wsl.onboarding.installOpencode": "Netsky Codeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Codeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Netsky CodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Netsky Codeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Netsky Codeでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Netsky Codeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNetsky Codeチームに報告してください: ",
  ...
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: Netsky CodeはまだMCP認証をサポートしていません。',
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNetsky Codeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Netsky Codeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNetsky Codeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description":
    "Netsky Codeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Netsky Codeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Netsky Code の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Netsky Code は最新バージョンです。",
