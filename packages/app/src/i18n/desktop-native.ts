...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Netsky Code failed to load",
  "desktop.recovery.terminated": "Netsky Code window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Netsky Code is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Netsky Code update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
