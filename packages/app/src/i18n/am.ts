export const dict = {
  ...
  "desktop.recovery.loadFailed": "Netsky Code መጫን አልቻለም",
  "desktop.recovery.terminated": "Netsky Code መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Netsky Code ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Codeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Netsky Code ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በNetsky Code ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "Netsky Code ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በNetsky Code ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በNetsky Code ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Netsky Code አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Netsky Codeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Netsky Code በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Netsky Code በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Netsky Code ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Netsky Code በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Codeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Netsky Code WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Netsky Code።",
  ...
  "help.tabs.introduction": "Netsky Code ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የNetsky Code ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Netsky Code እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "app.name.desktop": "Netsky Code ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የNetsky Code አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለNetsky Code",
  ...
  "settings.general.row.appearance.description": "Netsky Codeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Netsky Code ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Netsky Code ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Netsky Code ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የNetsky Code እትም እያሄዱ ነው።",
