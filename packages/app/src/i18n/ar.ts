export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Netsky Code",
  "desktop.recovery.terminated": "توقفت نافذة Netsky Code بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Netsky Code لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Netsky Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Netsky Code، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Netsky Code.",
  ...
  "dialog.server.description": "تبديل خادم Netsky Code الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Netsky Code في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Netsky Code في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Netsky Code في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Netsky Code في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Netsky Code من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Netsky Code التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Netsky Code.",
  ...
  "help.tabs.introduction": "أصبح Netsky Code الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Netsky Code ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Netsky Code",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Netsky Code لا يدعم مصادقة MCP بعد.',
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Netsky Code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Netsky Code",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Netsky Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Netsky Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Netsky Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Netsky Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Netsky Code.",
