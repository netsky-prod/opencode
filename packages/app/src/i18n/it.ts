export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Netsky Code.",
  ...
  "dialog.server.description": "Cambia il server Netsky Code a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Netsky Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Netsky Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Netsky Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Netsky Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Netsky Code possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Netsky Code ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Netsky Code non supporta ancora l\'autenticazione MCP.',
  ...
  "settings.desktop.wsl.description": "Esegui il server Netsky Code all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Netsky Code",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Netsky Code sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Netsky Code segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Netsky Code",
  ...
  "settings.updates.toast.latest.title": "Netsky Code è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Netsky Code.",
  ...
  "desktop.menu.documentation": "Documentazione di Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Netsky Code",
  "desktop.recovery.terminated": "La finestra di Netsky Code si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Netsky Code non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Netsky Code non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Netsky Code è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
