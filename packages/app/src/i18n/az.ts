export const dict = {
  ...
  "desktop.recovery.loadFailed": "Netsky Code yüklənə bilmədi",
  "desktop.recovery.terminated": "Netsky Code pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Netsky Code cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Netsky Code yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Netsky Code-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Netsky Code-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Netsky Code-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Netsky Code serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Code yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Netsky Code yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Netsky Code yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Netsky Code yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Netsky Code-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Netsky Code-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Netsky Code hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Netsky Code-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Netsky Code quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Netsky Code WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Netsky Code-u yenidən açın.",
  ...
  "help.tabs.introduction": "Netsky Code indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Netsky Code-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Netsky Code hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Netsky Code serverini işlət.",
  ...
  "settings.general.row.language.description": "Netsky Code üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Netsky Code-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Netsky Code-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Netsky Code-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Netsky Code açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Netsky Code-un ən son versiyasından istifadə edirsiniz.",
