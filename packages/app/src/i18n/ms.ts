export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Netsky Code gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Netsky Code ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Netsky Code tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Netsky Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Netsky Code selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Netsky Code.",
  ...
  "dialog.server.description": "Tukar pelayan Netsky Code yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Netsky Code dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Netsky Code dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Netsky Code dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Netsky Code dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Netsky Code boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Netsky Code ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Netsky Code",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Netsky Code belum menyokong pengesahan MCP.',
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Netsky Code dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Netsky Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Netsky Code pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Netsky Code mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Netsky Code dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Netsky Code.",
