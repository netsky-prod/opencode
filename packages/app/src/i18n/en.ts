...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Netsky Code.",
  ...
  "dialog.server.description": "Switch which Netsky Code server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Netsky Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Netsky Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Netsky Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Netsky Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Netsky Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Netsky Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Netsky Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Netsky Code does not support MCP authentication yet.',
  ...
  "settings.desktop.wsl.description": "Run the Netsky Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Netsky Code",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Netsky Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Netsky Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Netsky Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Netsky Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Netsky Code.",
