export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Netsky Code menyusi",
  ...
  "desktop.recovery.loadFailed": "Netsky Code yuklanmadi",
  "desktop.recovery.terminated": "Netsky Code oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Netsky Code javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Netsky Code yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Netsky Code’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Netsky Code da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Netsky Code da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Netsky Code serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Code tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Netsky Code {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Netsky Code yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Netsky Code {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Netsky Code-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Netsky Code-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Netsky Code tayyor.",
  "wsl.onboarding.installOpencodeIn": "Netsky Code-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Netsky Code-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Netsky Code WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Netsky Code-ni qayta oching.",
  ...
  "help.tabs.introduction": "Netsky Code endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Netsky Code ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Netsky Code hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Netsky Code bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Netsky Code serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Netsky Code uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Netsky Code qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Netsky Code tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Netsky Code mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description":
    "Netsky Code ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Netsky Code oxirgi versiyasini ishga tushiryapsiz.",
