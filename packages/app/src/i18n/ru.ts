export const dict = {
  ...
  "desktop.menu.documentation": "Документация Netsky Code",
  ...
  "desktop.menu.ariaLabel": "Меню Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Netsky Code",
  "desktop.recovery.terminated": "Окно Netsky Code неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Netsky Code не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить Netsky Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Netsky Code завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Netsky Code.",
  ...
  "dialog.server.description": "Выберите сервер Netsky Code, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка Netsky Code в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление Netsky Code в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите Netsky Code в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "Netsky Code готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите Netsky Code в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Netsky Code требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Netsky Code.",
  ...
  "help.tabs.introduction": "Теперь работа в Netsky Code организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Netsky Code ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Netsky Code",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Netsky Code пока не поддерживает MCP-авторизацию.',
  ...
  "settings.desktop.wsl.description": "Запускать сервер Netsky Code внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Netsky Code",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Netsky Code на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Netsky Code системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Netsky Code.",
