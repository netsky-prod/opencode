export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Netsky Code",
  ...
  "desktop.menu.ariaLabel": "Meniu Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Netsky Code nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Netsky Code s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Netsky Code nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Netsky Code a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Netsky Code s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Netsky Code.",
  ...
  "dialog.server.description": "Schimbă serverul Netsky Code la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Netsky Code în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Netsky Code în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Netsky Code în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Netsky Code în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Netsky Code să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Netsky Code ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Netsky Code nu suportă încă autentificarea MCP.',
  ...
  "settings.desktop.wsl.description": "Rulează serverul Netsky Code în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Netsky Code",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Netsky Code pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Netsky Code urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Netsky Code.",
