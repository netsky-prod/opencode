export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Netsky Code",
  ...
  "desktop.menu.ariaLabel": "Menu do Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Netsky Code",
  "desktop.recovery.terminated": "A janela do Netsky Code foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Netsky Code não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Netsky Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Netsky Code não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Netsky Code foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Netsky Code.",
  ...
  "dialog.server.description": "Trocar para qual servidor Netsky Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Netsky Code em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Netsky Code em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Netsky Code em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "O Netsky Code está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Netsky Code está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Netsky Code em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Netsky Code possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Netsky Code não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Netsky Code novamente.",
  ...
  "help.tabs.introduction": "Agora, o Netsky Code é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Netsky Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Netsky Code",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Netsky Code ainda não suporta autenticação MCP.',
  ...
  "settings.desktop.wsl.description": "Executar o servidor Netsky Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Netsky Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o Netsky Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Netsky Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Netsky Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Netsky Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Netsky Code.",
