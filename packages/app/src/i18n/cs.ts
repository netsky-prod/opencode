export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Netsky Code se nepodařilo načíst",
  "desktop.recovery.terminated": "Netsky Code okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Netsky Code nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Netsky Code aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Netsky Code.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Netsky Code serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Netsky Code v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Netsky Code v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Netsky Code v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Netsky Code do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Netsky Code může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Netsky Code ({{version}}).",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Netsky Code zatím nepodporuje ověřování MCP.',
  ...
  "settings.desktop.wsl.description": "Spusťte server Netsky Code uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Netsky Code",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Netsky Code na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Netsky Code následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Netsky Code.",
