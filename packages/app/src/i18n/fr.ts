export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Netsky Code",
  ...
  "desktop.menu.ariaLabel": "Menu Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Netsky Code",
  "desktop.recovery.terminated": "La fenêtre Netsky Code s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Netsky Code ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Netsky Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Netsky Code est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Netsky Code.",
  ...
  "dialog.server.description": "Changez le serveur Netsky Code auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Netsky Code dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Netsky Code dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Netsky Code dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Netsky Code dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Netsky Code puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Netsky Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Netsky Code",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Netsky Code ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Netsky Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Netsky Code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Netsky Code",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Netsky Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Netsky Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Netsky Code.",
