export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Netsky Code.",
  ...
  "dialog.server.description": "Skift hvilken Netsky Code-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Netsky Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Netsky Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Netsky Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Netsky Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Netsky Code igen.",
  ...
  "toast.update.description": "En ny version af Netsky Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Netsky Code-teamet",
  ...
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, Netsky Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.desktop.wsl.description": "Kør Netsky Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Netsky Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Netsky Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Netsky Code skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Netsky Codes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Netsky Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Netsky Code.",
  ...
  "desktop.recovery.loadFailed": "Netsky Code kunne ikke indlæses",
  "desktop.recovery.terminated": "Netsky Code-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Netsky Code mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Netsky Code er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Netsky Code er nu bygget op omkring faner.",
  "help.tabs.sessions":
