export const dict = {
  ...
  "desktop.recovery.loadFailed": "Netsky Code gagal dimuat",
  "desktop.recovery.terminated": "Jendela Netsky Code berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Netsky Code tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Netsky Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Netsky Code selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Netsky Code.",
  ...
  "dialog.server.description": "Ganti server Netsky Code mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Netsky Code di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Netsky Code di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Netsky Code di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Netsky Code di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Netsky Code dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Netsky Code ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Netsky Code belum mendukung autentikasi MCP.',
  ...
  "settings.desktop.wsl.description": "Jalankan server Netsky Code di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Netsky Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Netsky Code di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Netsky Code mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Netsky Code diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Netsky Code.",
