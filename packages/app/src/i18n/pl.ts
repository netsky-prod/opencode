export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Netsky Code",
  "desktop.recovery.terminated": "Okno Netsky Code zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Netsky Code nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Netsky Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Netsky Code została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Netsky Code.",
  ...
  "dialog.server.description": "Przełącz serwer Netsky Code, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Netsky Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Netsky Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Netsky Code w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Netsky Code w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Netsky Code będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Netsky Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Netsky Code",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Netsky Code nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Netsky Code wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Netsky Code",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Netsky Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Netsky Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Netsky Code.",
