export const dict = {
  ...
  "desktop.recovery.loadFailed": "Netsky Code kunde inte läsas in",
  "desktop.recovery.terminated": "Netsky Code-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Netsky Code svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Netsky Code misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Netsky Code-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Netsky Code.",
  ...
  "dialog.server.description": "Växla vilken Netsky Code-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Netsky Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Netsky Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Netsky Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Netsky Code i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Netsky Code kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Netsky Code igen.",
  ...
  "help.tabs.introduction": "Netsky Code är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Netsky Code ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Netsky Code stöder inte MCP-autentisering ännu.',
  ...
  "settings.desktop.wsl.description": "Kör Netsky Code-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Netsky Code",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Netsky Code ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Netsky Code följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Netsky Codes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Netsky Code startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Netsky Code.",
