...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Netsky Code įkelti nepavyko",
  "Netsky Code langas netikėtai užsidarė",
  "Netsky Code neatsako",
  ...
  "Netsky Code įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Netsky Code neįdiegtas distributyve {{distro}}",
  "Netsky Code naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Netsky Code.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Netsky Code serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Netsky Code {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Netsky Code {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Netsky Code {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Netsky Code į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Netsky Code galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Netsky Code ({{version}}) versiją.",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Netsky Code dar nepalaiko MCP autentifikavimo.",
  ...
  "app.name.desktop": "Netsky Code darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Netsky Code serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Netsky Code ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Netsky Code atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description":
    "Pasirinkite, ar Netsky Code seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Netsky Code temą.",
  ...
  "settings.updates.row.startup.description":
    "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Netsky Code versiją.",
