export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Netsky Code",
  ...
  "desktop.menu.ariaLabel": "Menuja Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Netsky Code nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Netsky Code u mbyll papritur",
  "desktop.recovery.unresponsive": "Netsky Code nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i Netsky Code dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Netsky Code përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Netsky Code.",
  ...
  "dialog.server.description": "Ndrysho me cilin server Netsky Code lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon Netsky Code në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Netsky Code po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson Netsky Code në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso Netsky Code në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni Netsky Code në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Netsky Code të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Një version i ri i Netsky Code ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Netsky Code nuk e mbështet ende vërtetimin MCP.',
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Netsky Code brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Netsky Code",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Netsky Code në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Netsky Code ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Netsky Code.",
