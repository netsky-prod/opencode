export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Netsky Codessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Netsky Codessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Netsky Codessa.",
  ...
  "dialog.server.description": "Vaihda Netsky Code-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Netsky Codea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Netsky Codea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Netsky Codea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Netsky Codea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Netsky Code jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Netsky Code jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Codea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Netsky Code voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Netsky Code uudelleen.",
  ...
  "toast.update.description": "Netsky Coden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Netsky Code-tiimille",
  "error.page.report.github": "GitHubissa",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Netsky Code ei vielä tue MCP-todennusta.',
  ...
  "settings.desktop.wsl.description": "Suorita Netsky Code-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Netsky Coden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Netsky Code näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Netsky Code järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Netsky Coden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Netsky Code käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Netsky Coden uusinta versiota.",
  ...
  "desktop.menu.documentation": "Netsky Code-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Netsky Code-valikko",
  ...
  "desktop.recovery.loadFailed": "Netsky Coden lataaminen epäonnistui",
  "desktop.recovery.terminated": "Netsky Code-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Netsky Code ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Coden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Codea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Netsky Coden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Netsky Code perustuu nyt välilehtiin.",
  "help.tabs.sessions":
