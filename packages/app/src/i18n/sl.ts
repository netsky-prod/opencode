export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Netsky Code ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Netsky Code se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Netsky Code se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Netsky Code ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Netsky Code je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Netsky Code.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Netsky Code se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Netsky Code ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Netsky Code v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Netsky Code ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Netsky Code v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Netsky Code v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Netsky Code v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Netsky Code doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Netsky Code ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Netsky Code še ne podpira avtentikacije MCP.',
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Netsky Code znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Netsky Code",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Netsky Code izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Netsky Code sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Netsky Code.",
