export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Netsky Code مینو",
  ...
  "desktop.recovery.loadFailed": "Netsky Code لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Netsky Code ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Netsky Code جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Netsky Code انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Netsky Code کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Netsky Code میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Netsky Code میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Netsky Code میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Netsky Code سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Code چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Netsky Code چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Netsky Code کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Netsky Code کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Netsky Code کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Netsky Code کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Netsky Code تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Netsky Code انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Netsky Code انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Netsky Code WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Netsky Code کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Netsky Code اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Netsky Code ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.chain.mcpFailed":
    'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Netsky Code ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "app.name.desktop": "Netsky Code ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Netsky Code سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Netsky Code کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Netsky Code کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Netsky Code سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Netsky Code کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Netsky Code لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Netsky Code کا تازہ ترین ورژن چلا رہے ہیں۔",
