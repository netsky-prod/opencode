export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code-documentatie",
  ...
  "desktop.recovery.loadFailed": "Netsky Code kan niet worden geladen",
  "desktop.recovery.terminated": "Het Netsky Code-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Netsky Code reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Netsky Code is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Netsky Code-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Netsky Code te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Netsky Code te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Netsky Code te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Netsky Code-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Code controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Netsky Code controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Netsky Code bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Netsky Code bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Netsky Code bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Netsky Code bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Netsky Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Netsky Code een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Netsky Code opnieuw.",
  ...
  "help.tabs.introduction": "Netsky Code is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Netsky Code ({{version}}) beschikbaar om te installeren.",
  ...
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" is mislukt. Let op: Netsky Code ondersteunt nog geen MCP-authenticatie.',
  ...
  "settings.desktop.wsl.description": "Voer de Netsky Code-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Netsky Code",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Netsky Code eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Netsky Code het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Netsky Code aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Netsky Code wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Netsky Code is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Netsky Code.",
