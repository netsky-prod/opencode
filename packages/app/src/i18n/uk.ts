export const dict = {
  ...
  "desktop.menu.documentation": "Документація Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Netsky Code",
  "desktop.recovery.terminated": "Роботу вікна Netsky Code несподівано завершено",
  "desktop.recovery.unresponsive": "Netsky Code не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Netsky Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Netsky Code завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Netsky Code.",
  ...
  "dialog.server.description": "Перемкніть сервер Netsky Code, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Netsky Code у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Netsky Code у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Netsky Code у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Netsky Code у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Netsky Code потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Netsky Code ({{version}}) тепер доступна для встановлення.",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Netsky Code ще не підтримує автентифікацію MCP.',
  ...
  "settings.desktop.wsl.description": "Запускати сервер Netsky Code всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Netsky Code",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Netsky Code на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description":
    "Виберіть, чи Netsky Code використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Netsky Code.",
