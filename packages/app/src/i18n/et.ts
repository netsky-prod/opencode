export const dict = {
  ...
  "desktop.recovery.loadFailed": "Netsky Code laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Netsky Code aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Netsky Code ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Netsky Code värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Netsky Code'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Netsky Code.",
  ...
  "dialog.server.description": "Lülitage, millise Netsky Code serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Code kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Netsky Code kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Netsky Code värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Netsky Code värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Netsky Code jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Netsky Code asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Netsky Code saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Netsky Code ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" ebaõnnestus. Pange tähele, Netsky Code ei toeta veel MCP autentimist.',
  ...
  "app.name.desktop": "Netsky Code Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Netsky Code server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Netsky Code kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Netsky Code teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Netsky Code järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Netsky Code on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Netsky Code käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Netsky Code uusimat versiooni.",
