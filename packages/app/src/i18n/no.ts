...
export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Netsky Code-meny",
  ...
  "desktop.recovery.loadFailed": "Netsky Code kunne ikke lastes inn",
  "desktop.recovery.terminated": "Netsky Code-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Netsky Code svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Netsky Code mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Netsky Code er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Netsky Code.",
  ...
  "dialog.server.description": "Bytt hvilken Netsky Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Netsky Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Netsky Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Netsky Code ikke støtter MCP-autentisering ennå.',
  ...
  "settings.desktop.wsl.description": "Kjør Netsky Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Netsky Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Netsky Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Netsky Code skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Netsky Code starter",
  ...
  "settings.updates.toast.latest.title": "Netsky Code er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Netsky Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Netsky Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Netsky Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Netsky Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Netsky Code i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Netsky Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Netsky Code på nytt.",
  ...
  "help.tabs.introduction": "Netsky Code er nå bygget rundt faner.",
  "help.tabs.sessions":
