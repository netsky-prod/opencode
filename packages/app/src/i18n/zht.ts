...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Netsky Code 載入失敗",
  "desktop.recovery.terminated": "Netsky Code 視窗意外終止",
  "desktop.recovery.unresponsive": "Netsky Code 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Netsky Code",
  "desktop.wsl.error.updateVersion":
    "Netsky Code 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Netsky Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Netsky Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Netsky Code 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Netsky Code 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Netsky Code...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Netsky Code 已就緒。",
  "wsl.onboarding.opencodeReady": "Netsky Code 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Netsky Code。",
  "wsl.onboarding.installOpencode": "安裝 Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Netsky Code",
  ...
  "wsl.onboarding.wslUnavailable.description": "Netsky Code 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Netsky Code。",
  ...
  "help.tabs.introduction": "Netsky Code 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Netsky Code 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Netsky Code 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Netsky Code 尚不支援 MCP 驗證。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Netsky Code 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Netsky Code 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Netsky Code 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Netsky Code 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Netsky Code 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Netsky Code 啟動時自動檢查更新",
