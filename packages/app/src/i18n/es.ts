export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Netsky Code",
  ...
  "desktop.menu.ariaLabel": "Menú de Netsky Code",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Netsky Code",
  "desktop.recovery.terminated": "La ventana de Netsky Code se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Netsky Code no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Netsky Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Netsky Code finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Netsky Code.",
  ...
  "dialog.server.description": "Cambiar el servidor de Netsky Code al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Netsky Code en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Netsky Code en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Netsky Code en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Netsky Code en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Netsky Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Netsky Code ({{version}}) está disponible para instalar.",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Netsky Code aún no admite la autenticación MCP.',
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Netsky Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Netsky Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Netsky Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Netsky Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Netsky Code.",
