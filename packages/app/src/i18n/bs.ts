export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Netsky Code",
  ...
  "desktop.menu.ariaLabel": "Netsky Code meni",
  ...
  "desktop.recovery.loadFailed": "Netsky Code se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Netsky Code-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Netsky Code ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Netsky Code-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Netsky Code-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Netsky Code-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Netsky Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Netsky Code-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Netsky Code server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Netsky Code u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Netsky Code u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Netsky Code u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Netsky Code u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Netsky Code mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Netsky Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Netsky Code timu",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: Netsky Code još ne podržava MCP autentifikaciju.',
  ...
  "settings.desktop.wsl.description": "Pokreni Netsky Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Netsky Code-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Netsky Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Netsky Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Netsky Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Netsky Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Netsky Code-a.",
