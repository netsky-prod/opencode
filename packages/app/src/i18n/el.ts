export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Netsky Code μενού",
  ...
  "desktop.recovery.loadFailed": "Netsky Code απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Netsky Code το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Netsky Code δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Netsky Code η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Netsky Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Netsky Code Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Netsky Code.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Netsky Code συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Netsky Code σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Netsky Code σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Netsky Code σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Netsky Code στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Netsky Code να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Netsky Code ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Netsky Code δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "app.name.desktop": "Netsky Code Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Netsky Code μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Netsky Code",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Netsky Code στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Netsky Code ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Netsky Code",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Netsky Code.",
