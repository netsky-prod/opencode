export const dict = {
  ...
  "desktop.menu.documentation": "Netsky Code دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Netsky Code لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Netsky Code دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Netsky Code جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Netsky Code انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Netsky Code دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Netsky Code وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Netsky Code وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Netsky Code وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس Netsky Code سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Code چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Netsky Code دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Netsky Code نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Netsky Code نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Netsky Code نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Netsky Code اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Netsky Code تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Netsky Code انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Netsky Code انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Netsky Code دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Netsky Code دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Netsky Code ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Netsky Code ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Netsky Code ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Netsky Code سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Netsky Code لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Netsky Code کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Netsky Code سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Netsky Code نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Netsky Code لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Netsky Code دا تازہ ترین ورژن چلا رئے او۔",
