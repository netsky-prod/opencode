...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Netsky Code yüklenemedi",
  "desktop.recovery.terminated": "Netsky Code penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Netsky Code yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Netsky Code kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Netsky Code güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Netsky Code'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Netsky Code'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Netsky Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Netsky Code sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Netsky Code kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Netsky Code kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Netsky Code güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Netsky Code güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Netsky Code'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Netsky Code'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Netsky Code hazır.",
  "wsl.onboarding.opencodeReady": "Netsky Code hazır.",
  "wsl.onboarding.installOpencodeIn": "Netsky Code'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Netsky Code'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Netsky Code'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Netsky Code'u tekrar açın.",
  ...
  "help.tabs.introduction": "Netsky Code artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Netsky Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Netsky Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "app.name.desktop": "Netsky Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "Netsky Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Netsky Code'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Netsky Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Netsky Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Netsky Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Netsky Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Netsky Code'un en son sürümünü kullanıyorsunuz.",
