export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Netsky Code",
  ...
  "desktop.recovery.loadFailed": "Không tải được Netsky Code",
  "desktop.recovery.terminated": "Cửa sổ Netsky Code đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Netsky Code không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Netsky Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Netsky Code chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Netsky Code nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Netsky Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Netsky Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Netsky Code.",
  ...
  "dialog.server.description": "Chuyển máy chủ Netsky Code mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Netsky Code...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Netsky Code trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Netsky Code...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Netsky Code trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Netsky Code trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Netsky Code",
  "wsl.onboarding.opencodeReadyIn": "Netsky Code đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Netsky Code đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Netsky Code trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Netsky Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Netsky Code chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Netsky Code có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Netsky Code không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Netsky Code.",
  ...
  "help.tabs.introduction": "Netsky Code nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Netsky Code ({{version}}) để cài đặt.",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Netsky Code chưa hỗ trợ xác thực MCP.',
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Netsky Code bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Netsky Code",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Netsky Code trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Netsky Code tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Netsky Code.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Netsky Code khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Netsky Code.",
