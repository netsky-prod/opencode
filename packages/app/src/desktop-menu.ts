...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://github.com/netsky-prod/opencode#readme" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://github.com/netsky-prod/opencode/issues" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://github.com/netsky-prod/opencode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        labelKey: "desktop.menu.reportBug",
        href: "https://github.com/netsky-prod/opencode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
